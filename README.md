...
- `algoritmo_binarizacion_hibrida.py`: implementación del algoritmo en Python.
- `Articulo.pdf`: artículo del proyecto.
- `PROYECTO VISION ARTIFICIAL.pdf`: informe del proyecto.
